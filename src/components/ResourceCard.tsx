...
const CATEGORY_STYLES: Record<StudyResource["category"], string> = {
  "Official IBM / Qiskit resources":
    "bg-blue-950/60 text-blue-300 ring-blue-500/30",
  "Community tutorials": "bg-violet-950/60 text-violet-300 ring-violet-500/30",
  "Practice exams": "bg-amber-950/60 text-amber-300 ring-amber-500/30",
  ...
  "Runtime / Sampler / Estimator references":
    "bg-cyan-950/60 text-cyan-300 ring-cyan-500/30",
  "OpenQASM references": "bg-rose-950/60 text-rose-300 ring-rose-500/30",
};
